...
class result1:
    ...
    def  __init__(self,root):
      ...
      btnfetch=Button(btnframe,command=self.fetchroll,text="Fetch ",font=("times new roman",12,"bold"),width=9,bg="gold",fg="black")
      btnfetch.grid(row=0,column=0,sticky=W,padx=9,pady=6)
     

      btnadd=Button(btnframe,command=self.adddata,text="Save",font=("times new roman",12,"bold"),width=9,bg="gold",fg="black")
      btnadd.grid(row=0,column=2,sticky=W,padx=10,pady=6)
      btnupdate=Button(btnframe,command=self.updatedata,text="Update",font=("times new roman",12,"bold"),width=9,bg="gold",fg="black")
      btnupdate.grid(row=0,column=3,sticky=W,padx=10,pady=6)
      btndelete=Button(btnframe,command=self.deteledata,text="Delete",font=("times new roman",12,"bold"),width=9,bg="gold",fg="black")
      btndelete.grid(row=0,column=4,sticky=W,padx=10,pady=6)

      btnclear=Button(btnframe,command=self.cleardata,text="Clear",font=("times new roman",12,"bold"),width=9,bg="gold",fg="black")
      btnclear.grid(row=0,column=5,sticky=W,padx=10,pady=6)
      btnexit=Button(btnframe,command=self.exit,text="Exit",font=("times new roman",12,"bold"),width=9,bg="gold",fg="black")
      btnexit.grid(row=0,column=6,sticky=W,padx=10,pady=6)
        #roll no#############################################################################################
      ...
      lblroll=Label(dataleftframe,text="*",font=("times new roman",18,"bold"),bg="white",fg="red")
      lblroll.grid(row=0,column=0,padx=2,pady=10,sticky=W)

      lblroll.place(x=90,y=10)
      ...
      m11=entry=ttk.Entry(dataleftframe,textvariable=self.varm1,font=("times new roman",13),width=12)

      m11=entry.grid(row=6,column=1,padx=2,pady=10,sticky=W)
   
      m11=entry.place(x=200,y=300)
      ################# subject2  #########################
      ...
      m21=entry=ttk.Entry(dataleftframe,textvariable=self.varm2,font=("times new roman",13),width=12)

      m21=entry.grid(row=6,column=3,padx=2,pady=10,sticky=W)
   
      m21=entry.place(x=550,y=300)
      ################# subject3 #########################
      ...
      m31=entry=ttk.Entry(dataleftframe,textvariable=self.varm3,font=("times new roman",13),width=12)

      m31=entry.grid(row=7,column=1,padx=2,pady=10,sticky=W)
   
      m31=entry.place(x=200,y=350)
      ################# subject4  ########################3
      ...
      m41=entry=ttk.Entry(dataleftframe,textvariable=self.varm4,font=("times new roman",13),width=12)

      m41=entry.grid(row=7,column=3,padx=2,pady=10,sticky=W)
   
      m41=entry.place(x=550,y=350)
      ################# subject5 #########################
      ...
      m51=entry=ttk.Entry(dataleftframe,textvariable=self.varm5,font=("times new roman",13),width=12)

      m51=entry.grid(row=8,column=1,padx=2,pady=10,sticky=W)
   
      m51=entry.place(x=200,y=400)
      ################# subject6  ########################3
      ...
      m61=entry=ttk.Entry(dataleftframe,textvariable=self.varm6,font=("times new roman",13),width=12)

      m61=entry.grid(row=8,column=3,padx=2,pady=10,sticky=W)
   
      m61=entry.place(x=550,y=400)
      ################# totalmarks#########################
      ...
      ################# obtainedmarks#########################
      btnobtainedmarks=Button(dataleftframe,command=self.add,text="Obtained  Marks : ",font=("times new roman",13,"bold"),width=16,bg="skyblue",fg="black")
    ...
    def adddata(self):
        if(self.varroll.get()=="" or self.varuniqueid.get()=="" or self.varname.get()=="" or self.varcourseid.get()==""):
            ...
            try:
                ...
                self.fetchdata()
                conn.close()
                messagebox.showinfo("Success","Student Result  has been added",parent=self.root)
    ...
    def add(self):
        res1=int(self.varm1.get())
        res2=int(self.varm2.get())
        res3=int(self.varm3.get())
        res4=int(self.varm4.get())
        res5=int(self.varm5.get())
        res6=int(self.varm6.get())
        sum=res1+res2+res3+res4+res5+res6
        self.varobtainedmarks.set(sum)
    def per(self):
        res1=int(self.varm1.get())
        res2=int(self.varm2.get())
        res3=int(self.varm3.get())
        ...
        sum=res1+res2+res3+res4+res5+res6
        self.varobtainedmarks.set(sum)
        r=sum*self.vartotalmarks.get()
        s=(r/self.varfullmarks.get())
        self.varpercentage.set(s)
    ...
    def updatedata(self):
        ...
        if(self.varroll.get()=="" or self.varuniqueid.get()=="" or self.varname.get()=="" or self.varcourseid.get()==""):
            ...
            try:
                update=messagebox.askyesno("Update","Are you sure to update this Result",parent=self.root)
                if update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="tiger@123",database="project")
                    mycursor=conn.cursor()
                ...
                messagebox.showinfo("success","Student's Result Updated Successfully",parent=self.root)
    ...
    def deteledata(self):
        if self.varroll.get()=="":
            ...
            try:
                Delete=messagebox.askyesno("Delete","Are you sure to Delete this Result",parent=self.root)
                if Delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="tiger@123",database="project")
                    mycursor=conn.cursor()
                ...
                conn.close()
                messagebox.showinfo("Delete","Student Result has been deleted",parent=self.root)
